...
public class ThreadLifeCycle {
     ...
     */
    public static String descStatus(String threadName, String threadStatus, boolean isAlive) {
        return threadName + "  " + IN_THE_STATE + threadStatus + "  " + ISALIVE_RETRUN + isAlive;
    }
    ...
    public static void printStatus(Thread thread) {
        System.out.println(descStatus(thread.getName(), thread.getState().toString(), thread.isAlive()));
    }
