...
public class CacheLockInterceptor implements InvocationHandler {
    ...
    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
        ...
        // 没有cacheLock注解，pass
        if(null == cacheLock) {
            System.out.println(Thread.currentThread().getName() + ", no cacheLock annotation");
            System.out.println(Thread.currentThread().getName() + ", no cacheLock annotation" + method.getName());
        ...
        if(!result) { // 取锁失败
            ...
            // throw new CacheLockException(Thread.currentThread().getName() + " get lock fail");
            return null;
        } else {
        ...
        try {
            ...
            if(e.getTargetException() instanceof InventoryException) {
                System.out.println(Thread.currentThread().getName() + ", 抢完了，没有库存了");
            }
        } finally {
            System.out.println(Thread.currentThread().getName() + ", intecepor 释放锁");
